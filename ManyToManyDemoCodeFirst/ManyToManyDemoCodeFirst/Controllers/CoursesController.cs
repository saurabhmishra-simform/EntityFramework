...
namespace ManyToManyDemoCodeFirst.wwwroot
{
    public class CoursesController : Controller
    {
        private readonly TeacherCourseContext _context;

        public CoursesController(TeacherCourseContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Courses != null ? 
                          ...
                          Problem("Entity set 'TeacherCourseContext.Courses'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'TeacherCourseContext.Courses'  is null.");
            }
            var course = await _context.Courses.FindAsync(id);
            if (course != null)
            {
