...
namespace OneToOneDemoCodeFirst.Controllers
{
    public class EventsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("EventId,EventName,EventPrice,EventDate,StudentId")] Event @event)
        {
            ...
            ViewData["StudentId"] = new SelectList(_context.Students, "StudentId", "StudentId", @event.StudentId);
            return View(@event);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EventId,EventName,EventPrice,EventDate,StudentId")] Event @event)
        {
            if (id != @event.EventId)
            {
                return NotFound();
